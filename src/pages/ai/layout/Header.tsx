                ...
                <div className="full-width">
                    ...
                    >
                        <Grid item md={7} order={{ xs: 2, md: 1 }}>
                            ...
                            >
                                Initially, we are researchers in the AI field, and our mission is to create something
                                new to solve business problems. In this field, we work with a limited amount of case
                                studies and tools.
                            </Typography>
                            <Button
                                variant="contained"
