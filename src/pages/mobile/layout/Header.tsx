                ...
                <div className="full-width">
                    ...
                    >
                        <Grid item md={7} order={{ xs: 2, md: 1 }}>
                            ...
                            >
                                The Mobile development process consists of design, development, debugging, and
                                integrations. All of those business needs could be covered by our team of experts.
                            </Typography>
                            <Button
                                variant="contained"
                                size="large"
